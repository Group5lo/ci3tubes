...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="<?php echo base_url() ?>admin">Admin Gadget</a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Data">
          ...
          <ul class="sidenav-second-level collapse" id="collapseExamplePages">
            ...
            <li>
              <a href="<?php echo base_url() ?>admin/gadget">Gadget</a>
            </li>
            <li>
              <a href="<?php echo base_url() ?>admin/brand">Brand</a>
            </li>
            <li>
              <a href="<?php echo base_url() ?>admin/stockprice">Stock and Price</a>
            </li>
            <li>
              <a href="<?php echo base_url() ?>admin/transaksi">Transaksi</a>
            </li>
            <li>
              <a href="<?php echo base_url() ?>admin/magazine">Magazine</a>
            </li>
          </ul>
        </li>
      </ul>
